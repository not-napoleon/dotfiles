...
-- The `servers` table will be automatically processed to ensure they are all
-- installed, and apply the appropriate configuration.
-- ==============================================================================
...
local servers = {
	...
	pylsp = {
		settings = {
			pylsp = {
				plugins = {
                    -- Disable these in favor of ruff
...
-- Include any servers not supporting configuration here
